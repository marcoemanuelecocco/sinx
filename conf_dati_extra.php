...
$smansione = htmlspecialchars($nmansione, ENT_NOQUOTES, "UTF-8");
...
$mansione = mysql_escape_string($smansione);
...
$tb_anagrafe = ('tb_anagrafe(nome, cognome, indirizzo, cap, citta, provincia, tel, tel2, mansione, email, nomerif, datan, tipologia, note, immagine)');
	if ($nome){ 
$sql="insert into $tb_anagrafe values('$nome', '$cognome', '$indirizzo', '$cap', '$citta', '$provincia', '$tel', '$tel2', '$mansione', '$email', '$nomerif', '$datan', 'Extra', '$note', '$file_name')"; //inserisco i valori nel database
