...
<div class='column' style="margin-left: 20px;"><small><i><? echo $Lrendicontoanno; ?></i><br>
<? echo $Lnuovoschema; ?><br><br> 
<? echo $Ldescrrendiconto; ?></li>
<br></small></div><br><br>

<?php
include('./menusx.inc');
?><hr><img src='./Immagini/suggerimento.png'><small><i><? echo $Lhelprendiconto; ?>
<hr></i></small><?
include('./botton.inc');
} else {
