...
foreach($tabelle as $tabella)
 mysql_query("truncate $tabella") or die(header('location: ./errore.html'));//"<b>Errore:</b> Impossibile eseguire la query della Combo"

$tabelle2 = array('tb_conto_economico','tb_stato_patrimoniale');
foreach($tabelle2 as $tabella)
 mysql_query("UPDATE $tabella SET valore='0'") or die(header('location: ./errore.html'));//"<b>Errore:</b> Impossibile eseguire la query della Combo"
