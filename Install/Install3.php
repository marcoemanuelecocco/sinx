...
<tbody>
 <tr>
            ...
            <tr>
              <td width='70%'>CAP:</td>
              <td><input name='cap' size='30%' type='text'></td>
            </tr>
            <tr>
            ...
            <tr>
              <td width='70%'>Fax:</td>
              <td><input name='fax' size='30%' type='text'></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input name='webmail' size='30%' type='text'></td>
            </tr>
            <tr>
              <td width='70%'>indirizzo sito internet:</td>
              <td><input name='sito' size='30%' type='text'></td>
            </tr>
            <tr>
