...
$liquidita = $entrata_tot[0]+$entratab_tot[0];
...
<!-- Sezione per inserire una nuova voce del bilancio economico -->
      ...
      <form action='./conf_dati_BilancioEcAps.php' method='POST'>
	    ...
	    <colgroup width="60%"></colgroup>
          <tbody>
            <tr>
              <td width='30%'><font color="red">Anno: <input name='anno' type='text' value=<? echo $data ?>><br><small><sub><i>Anno del bilancio</small></i></sub></td>
		<td size='60%'><small>Verbale assemblea dei soci n.<input name='Assemblea' type='text'></small></td>
		  <td size='10%'><small>del<br><input name='data' type='text' size='8%'></small></td>
            </tr>
            <tr>
              <td>Liquidit&agrave Iniziale<br><small><sub>(Cassa+Banca+Titoli)</sub></small></td>
		<td></td>
		  <td><input name='liquidita' type='text' size='8%' value=<?echo $liquidita?>></td>
	    </tr>
	    <tr>
	      <td><h3>Entrate<h3></td>
	    </tr>
...
?>
		...
		<td><small>Liquidit&agrave Cassa</td>
		  <td><input name='Cassa' type='text' size='8%' value=<?echo $entrata_tot[0];?>></td>
<?php
...
?>
		...
		<td><small>Liquidit&agrave banca</td>
		  <td><input name='Banca' type='text' size='8%' value=<?php echo $entratab_tot[0]; ?>></td>
	    </tr>
            <tr>
