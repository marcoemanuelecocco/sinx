...
<html>
<head>
  <title>Nuova anno sociale</title>
  <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>
<body>
<div style="text-align: center;"><span
 style="font-weight: bold;"><br>ATTENZIONE<br><br>
!!! Premendo il pulsante azzera, si cancelleranno tutti i dati contabili !!!</span><br style="font-weight: bold;"><br>
...
<hr style="width: 80%; height: 2px;">
 ...
 href="./index2.php">Annulla/Esci</a></span><br>
</div>
</body>
</html>
...
<?php
include('./menusx.inc');
?><hr><img src='./Immagini/suggerimento.png'><small><i>Premendo 'Archivia' otterrai un resoconto di tutti i dati registrati pronto per essere salvato o stampato.
<hr></i></small><?
include('./botton.inc');
} else {
