...
echo "Problemi nell'upload del file immagine";
...
echo "Immagine caricata con successo, &egrave necessario associarla all'utente sulla funzione 'modifica' scheda associato";
redirect('./gest_files.php',4);
