...
if ($user) {
	...
	$totaleent = ($nValore10+$nValore20+$nValore30+$nValore40+$nValore50+$nValore60);
...
<hr style="width: 60%; height: 2px;">
        <table align='center' border='0' width='90%'>
          <tbody>
            <tr>
              <td width='20%'>Liquidit&agrave iniziale <br><small><sub>(Cassa+Banca+Titoli)</sub></small></td>
		<td size='60%'></td>
		  <td size='10%'></td>
		    <td size='10%'>$nLiquidita</td>
            </tr>
	    <tr bgcolor='pink'>
...
<hr>
Estremi di approvazione bilancio: verbale di assemblea dei soci n. $Assemblea - del $Data - <small>(da allegare)</small><br><br>
