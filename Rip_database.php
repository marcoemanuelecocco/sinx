...
?>
<h2><? echo $Lpresentazionebackup; ?></h2>
<hr width='80%'><br>

<h3><? echo $Lbackup; ?></h3>
<center><sub><i><? echo $Lcomandobackup; ?></center>
...
<h3><? echo $Lripristino; ?></h3>
<center><sub><i><? echo $Listrripristino; ?></center>
<br>
      <form action='conf_ripBack.php' method='POST' enctype="multipart/form-data">
<table align='center' width='60%'>

	    <tr>
	      <td width='30%'><? echo $Lfilebackup; ?><input type="hidden" name="MAX_FILE_SIZE" value="300000000"> </td>
