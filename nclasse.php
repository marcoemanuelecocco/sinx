...
?>
      ...
      <center><h3>Inserimento Nuova Funzione o mansione</h3></center>
...
<!-- Inserimento Voci db -->
      <form action='./conf_nmateria.php?Tabella=tb_classe&Colonna=classe' method='POST'>
        <table align='center' border='0' width='60%'>
          <tbody>
            <tr>
              <td width='150'>Nuova Funzione:</td>
...
<center><h3>Mansioni o funzioni inserite nel database</h3></center>
<?php
...
<table class='bordo' align='center' cellpadding='0' cellspacing='0' width='50%'>
	<tr>
	<td height='25px' width='125' align='center'><small><b>id_funzione</b></small></td>
	<td width='125'><small><b>funzione</b></small></td>
	</tr>
	<tr><td></td></tr>
...
EOT;
include('./menusx.inc');
?><hr><img src='./Immagini/suggerimento.png'><small><i>Le funzioni degli associati sono gi&agrave impostate di default, ma puoi sempre aggiungerne o modificare quelle esistenti
<hr></i></small><?
include('./botton.inc');
