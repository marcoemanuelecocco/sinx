...
<hr style="width: 60%; height: 2px;">
	<p align="center"><small><b><? echo $Lnuovavoce; ?></b></small></p>
<!-- Sezione per inserire una nuova voce -->
      ...
      <form action='./conf_dati_patrim.php' method='POST'>
		...
		<td><input name='valore' size='30' type='text'><br><small><sub><i><? echo $Lnotavalore; ?></small></i></sub></td>
            </tr>
            <tr>
  ...
  <small><? echo $Lattivita; ?></small><input type="radio" name="patrim" value="attivita" checked="checked"/>
  <small><? echo $Lpassivita; ?></small><input type="radio" name="patrim" value="passivita"/>
	      </fieldset>
	    </td>
            </tr>
            <tr>
