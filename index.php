...
<tr bgcolor="#efefef"><td colspan="2">
 <fieldset>
  ...
  <small>Eng </small><input type="radio" name="lang" value="./lang/ita/" disabled/><img src='./ImmTemplate/flag_eng.png'>
</fieldset>
	</td></tr>
<tr>
...
<td align="center" bgcolor="#efefef"><br>
    ...
    <tr bgcolor="#efefef"><td><center><i><small><sub><input name="versione" size='5%' readonly="text" value=" 0.96.5"></sub></small></i></center></td>
